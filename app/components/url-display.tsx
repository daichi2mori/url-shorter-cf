		...
		<>
			<div className="bg-[#F8FAFC] mt-7 pt-4 px-4 pb-3 rounded md:flex md:items-center md:justify-between">
				...
				<div className="md:flex md:items-center">
					<div className="mt-1.5 md:mt-0 md:mr-8">
						<p className="text-base text-blue-500" ref={copyRef}>
							{shortUrl}
						</p>
						<p className="mt-1.5 md:mt-0">
					...
					<button
						...
						className="bg-[#A0C238] mt-2 text-white text-xs leading-7 text-center font-mono w-full rounded md:text-sm md:leading-8 md:w-20 md:mt-0"
					>
						コピー
					</button>
				</div>
